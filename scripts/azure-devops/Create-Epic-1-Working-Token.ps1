# Create Epic 1 using the working Azure CLI token

$organization = "hana-x"
$projectName = "Citadel"

Write-Host "Creating Epic 1 using working Azure CLI token..." -ForegroundColor Cyan

# Get the access token (you already have this working)
...
try {
    ...
    $epicData = @{
        ...
        Method = "Azure CLI Token (Working)"
    }
