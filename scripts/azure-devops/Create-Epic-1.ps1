# ===================================================================
# Script to Create Epic 1: Infrastructure Foundation in Azure DevOps
# ===================================================================
...
# A) Set up the authentication header
...
# B) Construct the API URL
$uri = "https://dev.azure.com/$($organization)/$($project)/_apis/wit/workitems/`$$($workItemType)?api-version=$($apiVersion)"

# C) Create the JSON body for Epic 1: Infrastructure Foundation
$body = @"
[
  {
    "op": "add",
...
try {
    Write-Host "`nAttempting to create Epic 1 in project '$project'..." -ForegroundColor Yellow
    ...
    Write-Host "2. Check that project '$project' exists in organization '$organization'" -ForegroundColor White
